...
source(file.path(path_dhs, "dhs", "00_r_script", "02_a_dhs_dqa.R"))
source(file.path(path_dhs, "dhs", "00_r_script", "02_b_gis_dqa.R"))
#source(file.path(path_dhs, "dhs", "00_r_script", "03_data_cleaning.R"))
source(file.path(path_dhs, "dhs", "00_r_script", "03_a_dhs_data_cleaning.R"))
source(file.path(path_dhs, "dhs", "00_r_script", "03_b_gis_data_cleaning.R"))
source(file.path(path_dhs, "dhs", "00_r_script", "03_c_spatial_merge.R"))
